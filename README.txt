...
[1-7]. The implementations are not particularly clear, efficient, well tested 
...
References
----------
[1] Nielsen, Michael. Neural Networks and Deep Learning, 
    Available in http://neuralnetworksanddeeplearning.com, 2015.

[2] Hinton, Geoffrey. Neural Networks for Machine Learning,
    Available in http://www.coursera.org, 2012.

[3] Li, Fei-Fei and Karpathy, Andrej. Convolutional Neural Networks for Visual Recognition,
    Available in http://cs231n.github.io/convolutional-networks, 2015.

[4] Simonyan, Kare, and Zisserman, Andrew. Very deep convolutional networks for large-scale image recognition,
    Available in http://arxiv.org/abs/1409.1556, 2014.
